        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <ul class="login_footer">
                    ...
                    <li style="margin-top: 5px;"><div class="fb-login-button" data-max-rows="1" data-size="large" data-show-faces="false" data-auto-logout-link="false" onclick="alert("message")"></div></li>
                </ul>
            </div>
        </div>
    </div>
